...
const BackstopReferenceBaseUrl = 'https://auto-update-review-signal-pantheon-professional-test-site.pantheonsite.io/';
const BackstopTestUrl = 'https://live-review-signal-pantheon-professional-test-site.pantheonsite.io/';
...
const simple_scenarios_paths = [
  ...
  "/other-tools/",
  // Single post
  "/2016/04/30/review-signal-wordpress-hosting-performance-benchmarks/",
  // Date archive
  "/2016/04/",
  // Category archive
